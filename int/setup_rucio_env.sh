...
export FNAL_RUCIO_VERSION=1.22.3
...
export FNAL_EXP_RUCIO_CERT=rucio-int.okd.fnal.gov-cert.pem
export FNAL_EXP_RUCIO_KEY=rucio-int.okd.fnal.gov-key.pem
export FNAL_EXP_RUCIO_CERT_KEY_COMBINED=rucio-int.okd.fnal.gov-combined.pem
