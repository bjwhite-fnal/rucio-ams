...
kubectl create secret generic fts-secrets \
	--from-file=fts_usercert.pem=$FNAL_EXP_RUCIO_CONF_DIR/certs/rucio-dev.fnal.gov-cert.pem \
	--from-file=fts_userkey.pem=$FNAL_EXP_RUCIO_CONF_DIR/certs/rucio-dev.fnal.gov-key.pem 
