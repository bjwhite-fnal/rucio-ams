...
kubectl create secret generic host-cert-key-combined \
	--from-file=hostcertkeycombined.pem=$FNAL_RUCIO_DIR/$EXPERIMENT/certs/$FNAL_EXP_RUCIO_CERT_KEY_COMBINED 
