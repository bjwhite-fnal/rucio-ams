...
* Set `metacat_base_url = <base URL>` in the `policy` section of the Rucio configuration file. The default value for this URL is `https://dbdata0vm.fnal.gov:9443/dune_meta_demo/`.
